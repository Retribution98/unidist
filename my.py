...
def check_serialize(df):
    ...
    time_2 = time.time()
    result = serializer.deserialize(s_data)
    time_3 = time.time()
    ...
    time_5 = time.time()
    result_5 = pickle.loads(data_5, buffers=buffers)
    time_6 = time.time()

    time_7 = time.time()
    data_4 = pickle.dumps(df, protocol=4)
    time_8 = time.time()
    result_4 = pickle.loads(data_4)
    time_9 = time.time()
...
def check_recv_communication(comm, source_rank):
    ...
    time_1 = time.time()
    result = recv_complex_data(comm, source_rank)
    time_2 = time.time()

    time_3 = time.time()
    result_2 = comm.recv(source=source_rank)
    time_4 = time.time()
